...
echo "  --set-env-vars \"REDIS_URL=redis://10.85.154.187:6379,GOOGLE_CLOUD_PROJECT_ID=durable-ring-475417-g0,GOOGLE_APPLICATION_CREDENTIALS=/app/.credentials/service-account.json,GOOGLE_MAPS_API_KEY=\${GOOGLE_MAPS_API_KEY},GCP_SA_JSON=/app/.credentials/service-account.json,RUN_WORKER=false\" \\"
echo "  --timeout 60"
echo ""
...
echo "  --vpc-connector redis-connector \\"
echo "  --vpc-egress private-ranges-only \\"
echo "  --set-env-vars \"REDIS_URL=redis://10.85.154.187:6379,GOOGLE_CLOUD_PROJECT_ID=durable-ring-475417-g0,GOOGLE_APPLICATION_CREDENTIALS=/app/.credentials/service-account.json,GOOGLE_MAPS_API_KEY=\${GOOGLE_MAPS_API_KEY},GCP_SA_JSON=/app/.credentials/service-account.json,RUN_WORKER=true\" \\"
