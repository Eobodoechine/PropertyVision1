...
class SmartDeduplicator {
        ...
        for (const [field, strategy] of Object.entries(mergeStrategies)) {
            ...
            switch (strategy) {
                ...
                case 'highest':
                    ...
                    resolution = values.sort((a, b) => (confidenceOrder[b] || 0) - (confidenceOrder[a] || 0))[0];
    ...
    addProperty(property) {
        ...
        const isDuplicate = group.properties.some(existing => this.calculateSimilarity(property, existing) > 80);
